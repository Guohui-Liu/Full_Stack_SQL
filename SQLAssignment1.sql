...
*/
SELECT CONCAT ('NAME: ',Name,' -- ','COLOR: ',Color) FROM Production.Product
WHERE Color is not Null
...
*/
SELECT * FROM Production.Product
where name like 'SPO%' or name not like 'SPOK%'
order by [Name] 
...
WHERE  Color not IN ('Red','Black') or ProductSubCategoryID = 1 or ListPrice BETWEEN 1000 AND 2000
