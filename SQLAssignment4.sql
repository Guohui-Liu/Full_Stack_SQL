...
--9
create table city_liu(id int not null primary key, name varchar(64))
create table people_liu(id int not null primary key,name varchar(64),
city int foreign key references city_liu(id))
Insert into city_liu(id,name) values(1, 'Seattle'),(2,'Green Bay')
Insert into people_liu(id,name,city) 
values (1,'Aaron Rodgers',2),
(2,'Russell Wilson',1),(3,'Jody Nelson',2)
delete from city_liu where name='Seattle'
--10
create proc sp_birthday_employees_Liu

as
begin
    create table birthday_employees_your_Liu
	(EmployeeID int primary key, Lastname varchar(64),Firstname varchar(64), BirthDate datetime)
	insert into birthday_employees_your_Liu 
